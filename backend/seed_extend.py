"""
CLEARWAY 항공 데이터 확장 시드 — 2026-06-01 ~ 2026-12-31
기존 데이터는 그대로 두고 새 기간만 INSERT.
실행: python seed_extend.py
"""
import random
...
try:
    ...
    while day <= end:
        ...
        print(f"  {day} – {len(batch):3d}편 추가")
        day += timedelta(days=1)

    print(f"\n✓ 완료: {total_added}편 삽입 | 마지막 번호 CW{counter-1:05d}")
